...
export const paths = {
  ...
  dashboard: {
    ...
    user: {
      ...
      details: (id: string) => `${ROOTS.DASHBOARD}/user/${id}/payroll-range`,
    ...
    partner: {
      ...
      details: (id: string) => `${ROOTS.DASHBOARD}/partner/${id}`,
    },
    warehouse: {
    ...
    category: {
      ...
      itemList: `${ROOTS.DASHBOARD}/items/list`,
      cateList: `${ROOTS.DASHBOARD}/category/list`,
    },
    species: {
      root: `${ROOTS.DASHBOARD}/species`,
      list: `${ROOTS.DASHBOARD}/species/list`,
      details: (id: string) => `${ROOTS.DASHBOARD}/species/${id}`,
