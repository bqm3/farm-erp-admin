...
import { listAttendances, checkInAttendance, listAttendanceUsers, type AttendanceRow, type UserOption } from 'src/api/attendance';
            ...
            <Card sx={{ p: 2, mb: 2 }}>
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems={{ sm: 'center' }}>
                    ...
                    <Button
                        ...
                        onClick={fetchData}
                        disabled={loading}
                        startIcon={loading ? <CircularProgress size={18} /> : <Iconify icon="solar:filter-bold" />}
